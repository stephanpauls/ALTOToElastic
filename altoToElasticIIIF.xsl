...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="annoURI" select="'http://localhost/IIIFAltoConvertor/canvas-FL42308769.json'"/>
    <!--
...
-->    
    ...
    <xsl:param name="canvasURI" select="'https://lib.is/IE42308767/canvas/canvas-FL42308769.json'" />
    <!--
    ...
    -->
    <xsl:param name="manifestURI" select="'https://lib.is/IE42308767/manifest'"/>
    <xsl:variable name="quote">'</xsl:variable>
    <xsl:variable name="doubleqoute">"</xsl:variable>
    <xsl:template match="/">
        <xsl:for-each select="//*[local-name()='String']">
